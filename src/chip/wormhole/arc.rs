...
fn arc_read32(chip: &mut Wormhole, addr: u32) -> Result<u32, luwen::ttkmd_if::PciError> {
...
/// wrong.
fn trigger_fw_int(chip: &mut Wormhole, addrs: &ArcMsgAddr) -> Result<bool, ArcMsgError> {
