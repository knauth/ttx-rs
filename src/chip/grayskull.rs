...
fn arc_read32(chip: &Chip, addr: u32) -> Result<u32, luwen::ttkmd_if::PciError> {
    chip.device.read32(addr)
}

fn arc_write32(chip: &Chip, addr: u32, value: u32) -> Result<(), luwen::ttkmd_if::PciError> {
    chip.device.write32(addr, value)
}
...
/// wrong.
fn trigger_fw_int(chip: &Chip, addrs: &ArcMsgAddr) -> Result<bool, ArcMsgError> {
